document.addEventListener('DOMContentLoaded', function () {
    ...
    if (hasInduction) {
        ...
        const checkboxMappings = {
            ...
            cardiac_transplant: ["cardiac_problems_list", "Cardiac-Transplant"],
...
function collectFormData() {
    const formData = {
        ...
        cardiac_transplant: document.querySelector('input[name="cardiac_problems_list"][value="Cardiac-Transplant"]')?.checked ? 1 : 0,
